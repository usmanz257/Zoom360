...
@Component({
  selector: 'app-qulaity',
  templateUrl: './qulaity.component.html',
  styleUrls: ['./qulaity.component.css']
})
export class QulaityComponent extends AppComponentBase implements OnInit {
...
getproductionprocessData(){
  ...
  this.productionprocess = 'Quality';
