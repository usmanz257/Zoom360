...
export class IdentityControlService {

_getDropDownUrl= environment.apiUrl+'/api/CommonDropdownList/GetDropdownList';
_saveIdentityControlUrl=environment.apiUrl+'/api/IndentityAndAccessmanagement/SaveIdentityControlSetup';
userId:string='admin';
...
Status_message:string;
  ...
  saveIndentityControlSetup(UserData:IdentityControlModel){
