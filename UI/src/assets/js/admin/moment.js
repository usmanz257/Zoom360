;(function (global, factory) {
            ...
            if (locales[name] != null) {
                deprecateSimple(
                    ...
                    'use moment.updateLocale(localeName, config) to change ' +
                        ...
                        'See js/moment.js for more info.'
                );
    ...
    var prototypeMin = deprecate(
            'moment().min is deprecated, use moment.max instead. js/moment.js',
            function () {
        ...
        prototypeMax = deprecate(
            'moment().max is deprecated, use moment.min instead. js/moment.js',
            function () {
                var other = createLocal.apply(null, arguments);
                if (this.isValid() && other.isValid()) {
                    return other > this ? this : other;
    ...
    proto.zone = deprecate(
        'moment().zone is deprecated, use moment().utcOffset instead. js/moment.js',
        getSetZone
    );
    proto.isDSTShifted = deprecate(
        'isDSTShifted is deprecated. See js/moment.js for more information',
