...
{
   public class MySqlRepositoryBase<TEntity> : IMySqlRepositoryBase<TEntity> where TEntity : class
    {
        protected MySqlDbContext _Context;

        public MySqlRepositoryBase(MySqlDbContext repositoryContext)
        {
        ...
        public string ExecuteCommand(string spQuery, object[] parameters)
        {
            ...
            v_Message = ((MySqlParameter)rr).Value.ToString();
